...
const TAB_CONFIG = [
  { name: 'swipe', label: 'Swipe', Icon: Home },
  { name: 'crushes', label: 'Crushes', Icon: Heart },
...
function FloatingTabBar({ state, descriptors, navigation }: BottomTabBarProps) {
  ...
  const containerStyle = {
    ...
    elevation: 8,
    borderWidth: 1,
    borderColor: 'rgba(31,27,46,0.06)',
  };
  ...
  if (Platform.OS === 'ios') {
    return (
      <BlurView intensity={60} tint="light" style={containerStyle}>
        <View
          style={{
            backgroundColor: 'rgba(255,246,233,0.82)',
          }}
        >
          {inner}
        </View>
  ...
  return (
    <View style={[containerStyle, { backgroundColor: '#FFF6E9' }]}>
      {inner}
    </View>
  );
}
